...
@register_model("caat_transformer", dataclass=AttentionTransducerConfig) 
class CAATTransformerModel(FairseqEncoderDecoderModel):
...
@register_model_architecture("caat_transformer", "audio_caat_transformer")
...
@register_model_architecture("caat_transformer", "audio_caat")
def audio_cat(args):
