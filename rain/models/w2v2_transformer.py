...
DEFAULT_MAX_AUDIO_POSITIONS = 3200000

@dataclass
class W2V2STTransformerModelConfig(FairseqDataclass):
...
@register_model("w2v2_st_transformer", dataclass=W2V2STTransformerModelConfig) 
class W2V2STTransformer(FairseqEncoderDecoderModel):
...
@register_model_architecture("w2v2_st_transformer", "w2v2_st_transformer_base")
...
@register_model_architecture("w2v2_st_transformer", "w2v2_st_transformer_s")
