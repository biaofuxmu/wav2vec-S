...
class AudioTransformer(FairseqEncoderDecoderModel):
    ...
    def build_model(cls, args, task):
        ...
        # print(args.encoder_ffn_embed_dim)
        ...
        # print(args.decoder_attention_heads)
        # print(args.decoder_ffn_embed_dim)
        ...
        if args.pretrained_decoder_path is not None:
            ...
            print(f"loaded pretrained encoder from: {args.pretrained_decoder_path}")
        return model
