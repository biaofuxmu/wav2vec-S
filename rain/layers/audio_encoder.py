...
from .audio_convs import get_conv
...
class AudioTransformerEncoder(FairseqEncoder):
    def __init__(self, args,):
        ...
        if embed_dim != args.decoder_embed_dim:
            self.encoder_proj = nn.Linear(embed_dim, args.decoder_embed_dim)

    def build_conv_layers(self, args):
        return get_conv(args.conv_type)(args.num_mel_bins, args.encoder_embed_dim)
