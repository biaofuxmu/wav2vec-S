...
💥 **News** 💥: We provide an implementation of wav2vec-S with the [Transformers](https://github.com/huggingface/transformers) library at [wav2vec-S-hf](https://github.com/biaofuxmu/wav2vec-S/tree/main/wav2vec-S-hf) folder.
