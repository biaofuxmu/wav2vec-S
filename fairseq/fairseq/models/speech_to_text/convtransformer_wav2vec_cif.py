...
class ConvTransformerModelWac2VecCIF(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument(
            "--w2v2-model-path",
            default="/mnt/nas/users/fubiaobiao.fu/mosst/pretrain_models/wav2vec_small.pt",
            type=str,
...
class ConvTransformerW2VCIFEncoder(FairseqEncoder):
    ...
    def __init__(self, args):
        ...
        # initialize wav2vec
        args.w2v2_model_path="/mnt/nas/users/fubiaobiao.fu/mosst/pretrain_models/wav2vec_small.pt"
        # print(args.w2v2_model_path)
