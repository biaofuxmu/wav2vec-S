...
class FairseqAdamConfig(FairseqDataclass):
    ...
    use_enc_dec_adam: bool = field(
        default=False, metadata={"help": "Use adam to optimize encoder and decoder with different lr"}
    )
    encoder_lr: float = field(
        default=1e-4, metadata={"help": "lr for encoder"}
    )
